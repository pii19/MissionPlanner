...
namespace GMap.NET.WindowsForms
{
   ...
   using OpenNETCF.ComponentModel;
    ...
    public partial class GMapControl : UserControl, Interface, IControl
    {
        ...
        /// </summary>
        public readonly ObservableCollectionThreadSafe<GMapOverlay> _Overlays =
      ...
      public Pen CenterPen = new Pen(Color.Red, 1);
        ...
        {
            get { return selectedAreaFillColor; }
            set
            {
                                            ...
                                            else
                                            {
                                                ...
                                                System.Drawing.RectangleF srcRect =
                                                    new System.Drawing.RectangleF(
                                                        ...
                                                        (float) (img.Yoff * (img.Img.Height / img.Ix)),
            ...
            try
            {
                using (Bitmap bitmap = new Bitmap(Width, Height))
                {
                    using (Graphics g = Graphics.FromImage(bitmap))
                    {
                        ...
                        {
#if !PocketPC
                            g.CopyFromScreen(PointToScreen(new System.Drawing.Point()).X,
                                PointToScreen(new System.Drawing.Point()).Y, 0, 0,
      ...
      protected override void OnPaintBackground(PaintEventArgs e)
      {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
...

            {
                ...
                e.Graphics.DrawImageUnscaled(Image.FromStream(new MemoryStream(sk.WriteImage())), 0, 0);
        ...
        protected virtual void OnPaintOverlays(IGraphics g)
        {
         ...
         g.DrawString("debug build", CopyrightFont, CopyrightBrush, 2, CopyrightFont.Size);
            ...
            {
#if !PocketPC
                g.DrawString(Core.provider.Copyright, CopyrightFont, Brushes.Navy, 3,
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            else
            {
                ...
                if (isSelected && !selectionStart.IsEmpty &&
                    (Form.ModifierKeys == Keys.Alt || Form.ModifierKeys == Keys.Shift || DisableAltForSelection))
                {
