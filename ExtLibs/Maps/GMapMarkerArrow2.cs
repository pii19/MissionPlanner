...
{
    [Serializable]
    public class GMapMarkerArrow2 : GMapMarkerBase
    {
        private readonly Bitmap icon = global::MissionPlanner.Maps.Resources.arrow;
        ...
        public GMapMarkerArrow2(PointLatLng p, float heading, float cog, float target, int sysid)
            : base(p)
        {
