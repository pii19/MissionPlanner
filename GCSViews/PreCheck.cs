    ...
    public partial class PreCheck : MyUserControl, IActivate, IDeactivate
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            if (MainV2.comPort.BaseStream != null && MainV2.comPort.BaseStream.IsOpen)
            {
                ...
                lblBattCharge.Text = cs.battery_remaining.ToString("0.0");
                lblBattCharge2.Text = cs.battery_remaining2.ToString("0.0");
                lblBattVolt.Text = cs.battery_voltage.ToString("0.0");
                lblBattVolt2.Text = cs.battery_voltage2.ToString("0.0");
                lblBattTemp.Text = cs.battery_temp.ToString("0.0");
                lblBattTemp2.Text = cs.battery_temp2.ToString("0.0");
                ...
                lblPitch.Text = cs.pitch.ToString("0.00");
                lblRoll.Text = cs.roll.ToString("0.00");
#if false
                var propo = cs.ch12in;
                if (cs.ch12in == 1400)
                {
                ...
                lblBattCell.Text = celldiff.ToString("0.00");
                ...
                lblBattCell2.Text = celldiff.ToString("0.00");
